...
-- Pregunta 2
SELECT  Departamento,
        COUNT (EmpleadosId) AS TotalEmpleados
FROM Empleados
...
-- Pregunta 4
SELECT COUNT (ClientesId)   AS CantidadClientesImportados
FROM Clientes;

-- Pregunta 5
SELECT  SucursalId,
        FORMAT (AVG (TotalCompra),'0.00')           AS  PromedioVentas,
